...
df = pd.read_pickle('RESOLVE-bn_V4.pkl') #RESOLVE catalog
...
data = gooddata & blue_nug #Michael's BN sample from edited .pkl file
...
sfdata1, = ax.plot(n2ha[sfsel], o3hb[sfsel], 'b.', label = 'SF')
...
sfdata4, = ax4.plot(n2ha[sfsel4], he2hb[sfsel4], 'b.')
agndata4, = ax4.plot(n2ha[agnsel4], he2hb[agnsel4],'yo')